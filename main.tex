...
Software Engineer and Technical Lead specializing in backend systems, IAM solutions, and cloud-native architectures. Currently pursuing an MSc in Artificial Intelligence while working at NTT DATA, combining enterprise software engineering experience with advanced AI and machine learning expertise.
\section{Experience}
...
\begin{onecolentry}
    \begin{highlights}
        ...
        \item Designed and implemented Spring Batch jobs for a large logistics client, processing hundreds of thousands of shipment records through complex transformation and enrichment pipelines.
        ...
        \item Currently leading a team of 5 engineers in the development of a sustainability platform for estimating CO$_2$ emissions generated by software systems, hardware infrastructure, and AI workloads.

        \item Serve as the primary technical point of contact for the client, coordinating requirements gathering, milestone planning, daily stand-ups, code reviews, and technical decision-making.
...
\begin{onecolentry}
    ...
    \textbf{Backend:} Spring Boot, Spring Batch, Spring Security, Gin, RabbitMQ \\
    \textbf{Cloud:} AWS, GCP, Kubernetes, Redis, Terraform \\
    \textbf{AI/Data:} PyTorch, Keras, Scikit-learn, Pandas, Optuna \\
...
\begin{highlights}
    ...
    \item Built and trained a 230k-parameter LSTM model on a dataset of 72,000+ samples, achieving 97.99\% test accuracy through token embedding and sequence preprocessing.
...
\begin{onecolentry}
    \begin{highlights}
        \item Developed a Progressive Web Application for roommate management, featuring inventory tracking, expense sharing, recipe suggestions, and task scheduling.
    \end{highlights}
\end{onecolentry}
...
\begin{onecolentry}
    \begin{highlights}
        \item \textbf{Thesis:} Development of a configurable connector for monitoring SCI and CO2 emissions of GreenIT® Google Cloud Platform components.
    \end{highlights}
\end{onecolentry}
