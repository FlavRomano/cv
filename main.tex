...
\begin{onecolentry}
    ...
    \textbf{Backend \& Cloud:} Spring Boot, FastAPI, Kubernetes, AWS, GCP, RabbitMQ, Redis, Terraform \\
...
\begin{twocolentry}{
    ...
    \textbf{Compliance Intelligence Platform} (\href{https://codeberg.org/Compliance-Intelligence-Platform}{codeberg})
\end{twocolentry}

\begin{highlights}
    \item Designed and developed an enterprise Retrieval-Augmented Generation (RAG) platform for sustainability compliance and due diligence analysis, enabling grounded question answering over regulatory and corporate documentation.

    \item Built an end-to-end document intelligence pipeline including text extraction, semantic chunking, embedding generation, metadata enrichment, and vector indexing using Qdrant.

    \item Implemented an evaluation framework for benchmarking retrieval and generation quality using Precision@K, Recall@K, Mean Reciprocal Rank (MRR), answer relevance, faithfulness, and context utilization metrics.
\end{highlights}
